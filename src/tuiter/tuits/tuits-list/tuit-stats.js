...
const TuitStats = (
    ...
    return (
        <div className="row wd-tuit-interactions pt-2 pb-2">
            ...
            <div className="wd-interaction-retweet col-2 align-content-center text-secondary">
                <a href="#" className="text-decoration-none text-secondary small">
                    <FontAwesomeIcon icon={faRetweet} className="pe-2 text-decoration-none text-secondary fa-1x"/>
                    {tuit.retuits}
                </a>
            </div>
            <div className="wd-interaction-like col-2  text-decoration-none text-secondary">
                <a href="#" className="text-decoration-none text-secondary small">
            ...
            <div className="wd-interaction-share col-2 text-decoration-none">
